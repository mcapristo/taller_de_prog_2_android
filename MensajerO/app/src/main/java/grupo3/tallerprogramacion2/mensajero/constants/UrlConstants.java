...
public class UrlConstants {
    ...
    public static final String BASE_URL = "http://192.168.1.140";
    ...
    public static String getConversationServiceUrl() { return (BASE_URL + LOCALHOST_PORT + API + CONVERSATION_SERVICE); }
    public static String getMessageServiceUrl() { return (BASE_URL + LOCALHOST_PORT + API + MESSAGE_SERVICE); }
}
